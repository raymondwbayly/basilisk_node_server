...
Configuration.prototype.getJSON = function() {
    return {'id':'0', 'name': this.getName(), 'developer':this.getDeveloper(), 'company':this.getCompany(), 'codename': this.getCodeName(), 'description': this.getDescription(), 'version': this.getVersion(), 'host': this.getHost(), 'port': this.getPort(), 'git': this.getGit(), "readmedoc":this.getDocumentReadme(), "installdoc":this.getDocumentInstall(), "versiondoc":this.getDocumentVersion(), "releasedoc":this.getDocumentRelease()};
}
