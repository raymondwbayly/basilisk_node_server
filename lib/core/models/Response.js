function Response(service, server, version, codename, message, data) {       // Accept name and age in the constructor
...
Response.prototype.getJSON = function() {
    let userRecord = {'service':this.getService(), 'server':this.getServer(), 'codename':this.getCodeName(), 'version':this.getVersion(), 'message':this.getMessage(), 'data':this.getData()};
    return userRecord;
}
