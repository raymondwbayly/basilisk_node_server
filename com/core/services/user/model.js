...
User.prototype.getJSON = function() {
    return {'id':this.getID().toString(), 'firstname':this.getFirstName(), 'lastname':this.getLastName(), 'email':this.getEmail(), 'password':this.getPassword(), 'phone':this.getPhone(), 'mobile':this.getMobile(), 'profilepic':this.getProfilePic(), 'active':this.getActive()};
}
